...
DEPLOY_PATH = os.getenv('AURORA_BLOG_ADMIN_SERVER_PATH')
...
def check_env():
    ...
    required_vars = {
        ...
        'AURORA_BLOG_ADMIN_SERVER_PATH': DEPLOY_PATH,
    ...
    if missing:
        ...
        print("  export AURORA_BLOG_ADMIN_SERVER_PATH='/path/to/deploy'")
